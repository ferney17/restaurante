...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center">Contactanos en nuestro WhatsApp</h2>
            Puedes mirar nuestro menu y hacer reservas con mas facilidad. !No dudes en preguntar para poder hacer tus pedidos sin recargo extra o hacer reservas!
        </div>
    </div>
</div>
   <footer>
